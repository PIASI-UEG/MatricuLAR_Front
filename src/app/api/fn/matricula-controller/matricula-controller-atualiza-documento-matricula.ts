...
export interface MatriculaControllerAtualizaDocumentoMatricula$Params {
  idMatricula: number;
...
export function matriculaControllerAtualizaDocumentoMatricula(http: HttpClient, rootUrl: string, params: MatriculaControllerAtualizaDocumentoMatricula$Params, context?: HttpContext): Observable<StrictHttpResponse<MatriculaDto>> {
  const rb = new RequestBuilder(rootUrl, matriculaControllerAtualizaDocumentoMatricula.PATH, 'post');
  if (params) {
...
matriculaControllerAtualizaDocumentoMatricula.PATH = '/api/v1/matricula/documento/atualiza-documento';
