...
export class AdvertenciaControllerService extends BaseService {
  ...
  /**
   * Path part for operation advertenciaControllerRemoverAdvertencia
   */
  static readonly AdvertenciaControllerRemoverAdvertenciaPath = '/api/v1/advertencia/remover-advertencia/{id-matricula}/{numero-advertencia}';

  /**
   * Remove alunos da turma
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `advertenciaControllerRemoverAdvertencia()` instead.
   *
   * This method doesn't expect any request body.
   */
  advertenciaControllerRemoverAdvertencia$Response(params: {
    'id-matricula': number;
    'numero-advertencia': number;
  },
  context?: HttpContext
    ...
    const rb = new RequestBuilder(this.rootUrl, AdvertenciaControllerService.AdvertenciaControllerRemoverAdvertenciaPath, 'delete');
    if (params) {
      rb.path('id-matricula', params['id-matricula'], {});
      rb.path('numero-advertencia', params['numero-advertencia'], {});
    }
   ...
   *
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `advertenciaControllerRemoverAdvertencia$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  advertenciaControllerRemoverAdvertencia(params: {
    'id-matricula': number;
    'numero-advertencia': number;
  },
  context?: HttpContext
    ...
    return this.advertenciaControllerRemoverAdvertencia$Response(params,context).pipe(
      map((r: StrictHttpResponse<AdvertenciaDto>) => r.body as AdvertenciaDto)
    );
  }
