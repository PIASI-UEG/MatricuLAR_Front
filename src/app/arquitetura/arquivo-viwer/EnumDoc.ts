...
export const EnumDocDescriptions: Record<EnumDoc, string> = {
  ...
  [EnumDoc.CPF_TUTOR1]: 'CPF do tutor',
  [EnumDoc.CPF_TUTOR2]: 'CPF do cônjuge',
  [EnumDoc.CERTIDAO_ESTADO_CIVIL]: 'Certidão de estado civil dos tutores',
  [EnumDoc.COMPROVANTE_TRABALHO_T1]: 'Carteira de trabalho / Comprovante de trabalho do tutor',
  [EnumDoc.CONTRA_CHEQUE1T1]: 'Contra-cheque 1 do tutor',
  [EnumDoc.CONTRA_CHEQUE2T1]: 'Contra-cheque 2 do tutor',
  [EnumDoc.CONTRA_CHEQUE3T1]: 'Contra-cheque 3 do tutor',
  ...
  [EnumDoc.DECLARACAO_ESCOLART1]: 'Declaração escolar do tutor',
